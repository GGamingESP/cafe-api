...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav"> <!-- Lista a la izquierda -->
                            <li class="nav-item">
                        ...
                        <ul class="navbar-nav ms-auto"> <!-- Lista a la derecha -->
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" id="cerrar_sesion" href="#">Cerrar sesión <svg
    ...
    <main class="container mt-4">
        <h1>Bienvenido a Majada Marcial</h1>
        <p>Nuestro sitio web designado especialmente a la creacion de los horarios semanales de los modulos de CIFP
            Majada Marcial.</p>

        <p>Totlamente acecsible y simple para los usuarios:</p>
        <ul>
            <li>Facil de usar</li>
            <li>Finalizacion en menos tiempo con menos problemas</li>
            <li>Simple y sensillo</li>
        </ul>
        <a href="/form" class="btn btn-primary">Ir al formulario
